...
const Banner = () => {
  ...
  return (
    <>
        <div className="mx-auto rounded-xl shadow-lg lg:w-[80%] mt-28 lg:mt-44 pt-24 lg:py-40 lg:px-10 flex flex-col lg:flex-row justify-around lg:items-center lg:gap-10 gap-24 bg-opacity-50 bg-base-300">
